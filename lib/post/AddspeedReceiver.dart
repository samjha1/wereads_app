...
class AddspeedReceiver extends StatefulWidget {
  const AddspeedReceiver({super.key});
...
class _AddRegisterPostReceiverState extends State<AddspeedReceiver> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      // API endpoint
      const String apiUrl =
          "https://api.indataai.in/wereads/addspeedreciver.php?action=save_registerpost";
