...
class AddRegisterPostSender extends StatefulWidget {
  const AddRegisterPostSender({super.key});

  @override
  AddRegisterPostSenderState createState() => AddRegisterPostSenderState();
}

class AddRegisterPostSenderState extends State<AddRegisterPostSender> {
