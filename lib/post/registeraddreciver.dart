...
class AddRegisterPostReceiver extends StatefulWidget {
  const AddRegisterPostReceiver({super.key});

  @override
  _AddRegisterPostReceiverState createState() =>
      _AddRegisterPostReceiverState();
}

class _AddRegisterPostReceiverState extends State<AddRegisterPostReceiver> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Prepare form data
      final formData = {
        "dt1": _dateController.text,
        "r_ilpclient": _ilpClientController.text,
        "r_legalopp": _legalOppController.text,
        "r_adress": _addressController.text,
        "r_mail": _emailController.text,
        "r_phone": _phoneController.text,
        "r_nature": _natureController.text,
        "r_casenum": _caseNumController.text,
        "r_section": _sectionController.text,
        "r_advocate": _selectedAdvocate,
        "status": _selectedStatus,
        "r_next_date": _actionDateController.text,
        "r_remarks": _remarksController.text,
        "roleSelector": "receiver", // Hidden value included
      };

      // API endpoint
      const String apiUrl =
          "https://api.indataai.in/wereads/addregieterreciver.php?action=save_registerpost";
