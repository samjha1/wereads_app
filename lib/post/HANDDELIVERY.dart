...
import 'package:wereads/post/AddhanddeliverySender.dart';
import 'package:wereads/post/Addhanddeliveryreceiver.dart';
import 'package:wereads/post/edithand.dart';

class HANDDELIVERYList extends StatefulWidget {
  const HANDDELIVERYList({super.key});

  @override
  _RegisterPostListState createState() => _RegisterPostListState();
}

class _RegisterPostListState extends State<HANDDELIVERYList>
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      final senderResponse = await http.get(
        Uri.parse('https://api.indataai.in/wereads/handsender.php'),
      ...
      final receiverResponse = await http.get(
        Uri.parse('https://api.indataai.in/wereads/handreviver.php'),
        headers: {'Content-Type': 'application/json'},
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Hand Delivery Posts'),
        bottom: TabBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Hand Delivery Details',
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final response = await http.post(
        Uri.parse(
            'https://api.indataai.in/wereads/addhandsender.php?action=save_registerpost'),
        body: {
