...
class DateAwaitedCasesPage extends StatefulWidget {
  const DateAwaitedCasesPage({super.key});

  @override
  _NotificationPageState createState() => _NotificationPageState();
}

class _NotificationPageState extends State<DateAwaitedCasesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('DateAwaited Cases'),
        backgroundColor:
