...
class DecidedCasesPage extends StatefulWidget {
  const DecidedCasesPage({super.key});

  @override
  _NotificationPageState createState() => _NotificationPageState();
}

class _NotificationPageState extends State<DecidedCasesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Decided Cases'),
        backgroundColor:
