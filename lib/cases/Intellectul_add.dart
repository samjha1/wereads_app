...
class IntellectulAdd extends StatefulWidget {
  const IntellectulAdd({super.key});

  @override
  _CorporateFormState createState() => _CorporateFormState();
}

class _CorporateFormState extends State<IntellectulAdd> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("INTELLECTUAL PROPERTY FORM"),
      ),
