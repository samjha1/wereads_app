...
import 'package:wereads/nonlitigation/liaisoning_Add.dart';

class LiaisoningList extends StatelessWidget {
  const LiaisoningList({super.key});

  // Fetch customer data from the API
  Future<List<Map<String, dynamic>>> fetchCustomerData() async {
    const apiUrl =
        'https://api.indataai.in/wereads/Liaisoning_list.php'; // Replace with your API URL
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  LiaisoningAdd(), // Replace with your desired page
            ),
          );
        },
        backgroundColor: Theme.of(context).primaryColor,
