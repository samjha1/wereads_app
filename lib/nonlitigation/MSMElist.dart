...
import 'package:wereads/nonlitigation/Msme_Add.dart';
import 'dart:convert';

class Msmelist extends StatelessWidget {
  const Msmelist({super.key});

  // Fetch customer data from the API
  Future<List<Map<String, dynamic>>> fetchCustomerData() async {
    const apiUrl =
        'https://api.indataai.in/wereads/Msme_list.php'; // Replace with your API URL
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => MsmeAdd(), // Replace with your desired page
            ),
          );
        },
        backgroundColor: Theme.of(context).primaryColor,
