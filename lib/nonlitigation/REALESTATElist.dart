...
import 'package:wereads/nonlitigation/RealstateForm.dart';
import 'dart:convert';
...
class Realestatelist extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> fetchCustomerData() async {
    const apiUrl =
        'https://api.indataai.in/wereads/realstate_list.php'; // Replace with your API URL
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  Realstateform(), // Replace with your desired page
            ),
          );
        },
        backgroundColor: Theme.of(context).primaryColor,
