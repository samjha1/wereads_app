...
class LiaisoningAdd extends StatefulWidget {
  const LiaisoningAdd({super.key});

  @override
  _CorporateFormState createState() => _CorporateFormState();
}

class _CorporateFormState extends State<LiaisoningAdd> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("LIAISONING FORM"),
      ),
