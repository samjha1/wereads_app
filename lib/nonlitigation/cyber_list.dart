...
import 'package:wereads/nonlitigation/cyber_add.dart';
import 'dart:convert';

class CyberList extends StatelessWidget {
  const CyberList({super.key});

  // Fetch customer data from the API
  Future<List<Map<String, dynamic>>> fetchCustomerData() async {
    const apiUrl =
        'https://api.indataai.in/wereads/cyber_list.php'; // Replace with your API URL
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  CyberAdd(), // Replace with your desired page
            ),
          );
        },
        backgroundColor: Theme.of(context).primaryColor,
