...
import 'package:wereads/cases/Intellectul_add.dart';
import 'dart:convert';

class Intellectul_list extends StatelessWidget {
  const Intellectul_list({super.key});

  // Fetch customer data from the API
  Future<List<Map<String, dynamic>>> fetchCustomerData() async {
    const apiUrl =
        'https://api.indataai.in/wereads/intellectual_list.php'; // Replace with your API URL
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  IntellectulAdd(), // Replace with your desired page
            ),
          );
        },
        backgroundColor: Theme.of(context).primaryColor,
